angular.module("circle.countdown", [])
  .directive("countdown", ["$timeout", "$interval", function($timeout, $interval) {
    return {
      ...
      restrict: "EA",
      template: '<div class="ClassyCountdown-wrapper"><div class="ClassyCountdown-days"><input value="{{ knob.seconds.value }}"/><span class="ClassyCountdown-value"><div></div><span></span></span></div><div class="ClassyCountdown-hours"><input value="{{ knob.seconds.value }}"/><span class="ClassyCountdown-value"><div></div><span></span></span></div><div class="ClassyCountdown-minutes"><input value="{{ knob.seconds.value }}"/><span class="ClassyCountdown-value"><div></div><span></span></span></div><div class="ClassyCountdown-seconds"><input value="{{ knob.seconds.value }}"/><span class="ClassyCountdown-value"><div></div><span></span></span></div></div>',
      replace: false,
